...
def plot_save_multi(Y, title, item, x_axis='Score',
    ...
    for architecture in Y:
        ...
        for action in Y[architecture]:
            ...
            plt.plot(x, y, color=colors[action_count % len(colors)], marker="o")
...
def plot_save(Y, title, item, x_axis='Score',
    ...
    for architecture in Y:
        ...
        plt.title(title + " for {}".format(architecture))
        plt.xlabel(x_axis)
        plt.yticks([], [])
...
plot_save(Y, "Score Variation per Action set", item="score", name="./{}/plots/score".format(plot_type))
plot_save(Y, "Time Variation per Action set", item="time", x_axis='Time [s]', name="./{}/plots/time".format(plot_type))
plot_save_multi(Y, "Score Variation", item="score", name="./{}/plots/score_all".format(plot_type))
plot_save_multi(Y, "Time Variation", item="time", x_axis='Time [s]', name="./{}/plots/time_all".format(plot_type))
